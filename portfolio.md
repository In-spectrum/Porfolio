...
## 🧩 Оптико-електронна системою відеоспостереження
...
## 🧩 Оптичний розвідувальний прилад
...
**Опис:**  
Портативний прилад для ведення розвідки за допомогою тепловізійного та денного відеоканалів.  
...
**Розробив:**  
Архітектуру та програмне забезпечення “меню користувача” для управління приладом,  
